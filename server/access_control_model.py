    ...
    try:
        ...
        if employee_info:
            ...
            if is_new_employee and past_violations > 0:
                ...
                if employee_dept != requested_dept:
                    ...
                    return False, f"New employees with {past_violations} past violations can only access their own department"
        ...
        if employee_dept in cross_dept_access and requested_dept in cross_dept_access[employee_dept]:
            ...
            if employee_info and past_violations > 0:
                ...
                return False, f"Cross-department access restricted due to {past_violations} past violations"
